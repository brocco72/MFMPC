...
analyze -format vhdl MFSKLADD.vhd

elaborate MFSKLADD -architecture structural -library WORK -parameters "gWordSize=>$WordSize"
...
write -format verilog -hierarchy -output MFSKLADD$WordSize.net
