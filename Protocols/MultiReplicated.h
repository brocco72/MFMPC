...
public:
    ...
    MultiReplicatedBase(Player& P, array<PRNG, 2>& prngs);
...
public:
    ...
    void randomize_comm_elem_0(const typename T::clear& share, int n = -1);
    void randomize_comm_elem_1(const typename T::clear& share, int n = -1);
    void randomize_comm_elem_2(const typename T::clear& share, int n = -1);
